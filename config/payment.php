...
return [
    ...
    'wechat' => [
        'DriverMiniApp' => [
            ...
            'mch_secret_key' => 'WANNINGYESHUchangshouquan1234567',
            // 必填-商户私钥 字符串或路径
            ...
            'notify_url' => 'https://0604guyi.95.hzgqapp.com/api/notify/wechat',
            // 选填-公众号 的 app_id
            // 可在 mp.weixin.qq.com 设置与开发->基本配置->开发者ID(AppID) 查看
            'mp_app_id' => '',
            // 选填-小程序 的 app_id
            'mini_app_id' => 'wx28afe61b57804d1a',
            // 选填-app 的 app_id
            'app_id' => '',
        ...
        'TransportMiniApp' => [
            ...
            // 必填-v3 商户秘钥
            // 即 API v3 密钥(32字节，形如md5值)，可在 账户中心->API安全 中设置
            'mch_secret_key' => 'ggacaKlq8QI76Gm0PbL16vHkXPJIzfSK',
            // 必填-商户私钥 字符串或路径
            // 即 API证书 PRIVATE KEY，可在 账户中心->API安全->申请API证书 里获得
            // 文件名形如：apiclient_key.pem
            'mch_secret_cert' => './config/payment/apiclient_key.pem',
            ...
            'mp_app_id' => '',
            // 选填-小程序 的 app_id
            'mini_app_id' => 'wx30e15dc9f1ac786b',
            // 选填-app 的 app_id
            'app_id' => '',
            // 选填-服务商模式下，子公众号 的 app_id
            'sub_mp_app_id' => '',
...
//            ],
        ...
        'UserMiniApp' => [
            ...
            'mp_app_id' => '',
            // 选填-小程序 的 app_id
            'mini_app_id' => 'wx65be4a4d436b7d2c',
            // 选填-app 的 app_id
            'app_id' => '',
            // 选填-服务商模式下，子公众号 的 app_id
            'sub_mp_app_id' => '',
